...
We are interested in determining if there is a predictive nature to this dataset. We also want to describe the scope of the dataset, detail the different trends overtime, and visualize... We strive to answer the following questions:
