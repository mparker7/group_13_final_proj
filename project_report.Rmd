...
<<<<<<< HEAD
After thorough analysis of the data, it was discovered that a single stop could contain multiple 'reason for stop'. Considering this, our analysis of the different reasons for stop could be misleading. This could explain why the "other" category for is among the highest. Our data also had a interesting distribution in age, ranging from 1 to 99. While we cannot question 

Distribution of race for stopped minors is consistent with the trend of the whole sample. Majority of minors stopped are black (1061 individuals) followed by the white-Hispanic (377 individuals). Percent of innocent minors per each race is around 80%, which is also consistent with the trend of the whole sample. Innocent individuals were determined to be those who were not arrested, after being stopped. It was calculated that the percent innocent within each race is equally distributed among the races and is around 80%. Taking into account the equal rates of innocence within each race and the fact that black or African American race make up only 25% of the New York City population, while composing over 50% of stopped individuals it can be concluded that NYPD expresses bias toward and conducting racial profiling of black individuals. 

=======
Distribution of race for stopped minors is consistent with the trend of the whole sample. Majority of minors stopped are black (1061 individuals) followed by the white-Hispanic (377 individuals). Percent of innocent minors per each race is around 80%, which is also consistent with the trend of the whole sample. After thorough analysis of the data, it was discovered that a single stop could contain multiple 'reason for stop'. Considering this, our analysis of the different reasons for stop could be misleading. This could explain why the "other" category for is among the highest. 

Innocent individuals were determined to be those who were not arrested, after being stopped. It was calculated that the percent innocent within each race is equally distributed among the races and is around 80%. Taking into account the equal rates of innocence within each race and the fact that black or African American race make up only 25% of the New York City population, while composing over 50% of stopped individuals it can be concluded that NYPD expresses bias toward and conducting racial profiling of black individuals. 
>>>>>>> d057081a9f3020c499d99afab33706d8f797c57e


<<<<<<< HEAD
=======
After looking at the total count of reasons for being stopped for each category there was sum of `19,110`. This could be misleading given that our data set only contain `r nrow(stop_frisk_df)` subjects. It appears that individuals could have been stopped for more than one reason which could possibly be why the "other" category is such a high quantity. For future analysis we could exclude people who were stopped for multiple reasons and just look at the people who were stopped for only one reason just so we could get a more feasible count of each category of reasons for being stopped.
